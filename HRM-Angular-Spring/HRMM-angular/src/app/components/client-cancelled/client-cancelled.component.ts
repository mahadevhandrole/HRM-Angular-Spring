...
@Component({
  selector: 'app-client-cancelled',
  templateUrl: './client-cancelled.component.html',
  styleUrls: ['./client-cancelled.component.css']
})
export class ClientCancelledComponent implements OnInit {

  clientcancelled:BusinessInfo;
  status:number=4;
...
ProcessResults(){
return data=>{
  this.clientcancelled=data._embedded.business_infoes;
