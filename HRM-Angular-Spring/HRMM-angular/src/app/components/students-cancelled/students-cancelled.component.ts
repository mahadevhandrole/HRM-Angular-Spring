...
@Component({
  selector: 'app-students-cancelled',
  templateUrl: './students-cancelled.component.html',
  styleUrls: ['./students-cancelled.component.css']
})
export class StudentsCancelledComponent implements OnInit {

  studentcancelled: StudentInfo;
  status: number = 4;
  ...
  ProcessResults() {
    return data => {
      this.studentcancelled = data._embedded.student_infoes;
