...
@Component({
  selector: 'app-students-account',
  templateUrl: './students-account.component.html',
  styleUrls: ['./students-account.component.css']
})
export class StudentsAccountComponent implements OnInit {
  ...
  ProcessResults() {
    return data => {
      this.studentaccount = data._embedded.student_infoes;
